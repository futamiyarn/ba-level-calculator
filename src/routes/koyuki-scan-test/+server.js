...
export async function POST({ request, platform }) {
	try {
		...
		const inputs = {
			image: imageArray,
			prompt:
				'Analyze this image. If it is a character profile or status screen (like from a game), extract the text and describe the character, level, and stats. Otherwise, describe the image.'
		};
